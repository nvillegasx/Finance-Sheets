<template>
    <div>
        ...
        <div class="OtherAssets">
            <div class="row">
                <div class="column">
                    <span class="rowTitle">Other Assets</span>
                </div>
                <div class="column2">
                    $<input type="number" name="otherAssets" v-model.number="otherAssets" placeholder="0" 
                    @keyup.enter="addItems(otherAssets,0); currVal[0].entered = true"
